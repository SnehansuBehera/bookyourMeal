...
const Header = () => {
    return (
        <nav className='rounded-2xl shadow-md shadow-slate-200 bg-transparent max-w-[1440px] mx-auto px-8 py-4 my-5 flex items-center justify-between'>
            <h1 className=' font-serif font-medium text-[4vw] md:text-[1.4vw]'>bookyourMeal</h1>
            <ul className='hidden md:flex md:gap-[3vw] md:justify-center md:items-center'>
                <li><Link to='/'><h2 className='font-semibold text-[1.2vw]'>Home</h2></Link></li>
                <li><Link to='/about'><h2 className='font-semibold text-[1.2vw]'>About</h2></Link></li>
                <li><Link to='/main'><h2 className='font-semibold text-[1.2vw]'>Menu</h2></Link></li>
                <li className=''><input className='w-[12vw] text-[1.2vw] rounded-2xl shadow-sm shadow-slate-400 font-normal py-2 px-4' type="text" placeholder='Search...' /></li>
            </ul>
